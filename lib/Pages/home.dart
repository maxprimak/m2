        ...
        body: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text('Your Subjects', style: TextStyle(fontSize: 20, fontFamily: 'Montserrat')),
              ),
              ...
              Center(child: Text('Total subjects: 5 ', style: TextStyle(fontSize: 13, fontFamily: 'Montserrat')),)
